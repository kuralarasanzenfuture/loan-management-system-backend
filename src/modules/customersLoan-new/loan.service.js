...
} from "./utils/installmentGenerator.js";
...
export const LoanService = {
  ...
  async create(data, user) {
    ...
    try {
      ...
      const end_date = calculateLoanEndDate({
      ...
      await generateAndSaveInstallments(conn, loan, plan);
  ...
  async update(id, data, user) {
    ...
    ----------------------------------------- */
      ...
      if (planChanged || amountChanged || dateChanged) {
        ...
        await generateAndSaveInstallments(
          conn,
