...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Interest-Only Loans",
        code: "MOD_INTEREST_ONLY_LOANS",
        path: "/interest-only-loans",
        description: "Active customer interest-only loan accounts",
      },
      {
        label: "Interest Loan Plans",
        code: "MOD_INTEREST_LOANS",
        path: "/interest-loans",
        description: "Active customer interest-only loan accounts",
      },
      {
        label: "Anytime Interest Loans",
        code: "MOD_ANYTIME_INTEREST_LOANS",
        path: "/anytime-interest-loans",
        description: "Active customer anytime interest-only loan accounts",
      },
      {
        label: "Anytime Interest Loan Payments",
        code: "MOD_ANYTIME_INTEREST_LOAN_PAYMENTS",
        path: "/anytime-interest-loan-payments",
        description: "Active customer anytime interest-only loan accounts",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: "Anytime Interest Collections",
        code: "MOD_ANYTIME_INTEREST_COLLECTIONS",
        path: "/anytime-interest-collections",
        description: "Collections tracking for anytime interest-only accounts",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Anytime Interest Loan Reports",
        code: "MOD_ANYTIME_INTEREST_LOAN_REPORTS",
        path: "/anytime-interest-loan-reports",
        description: "Anytime interest-only loan portfolio reporting",
      },
      {
        label: "Customer Reports",
        code: "MOD_REP_CUSTOMERS",
