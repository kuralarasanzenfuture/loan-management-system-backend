...
--         ===================================================== */
--         CONSTRAINT fk_bank_transaction_bank FOREIGN KEY (company_bank_id) REFERENCES company_banks (id) ON DELETE RESTRICT ON UPDATE CASCADE,
--         CONSTRAINT fk_bank_transaction_created_by FOREIGN KEY (created_by) REFERENCES users (id) ON DELETE SET NULL ON UPDATE CASCADE,
--         CONSTRAINT fk_bank_transaction_updated_by FOREIGN KEY (updated_by) REFERENCES users (id) ON DELETE SET NULL ON UPDATE CASCADE,
--         CONSTRAINT fk_bank_transaction_reversal FOREIGN KEY (reversal_id) REFERENCES bank_transactions (id) ON DELETE SET NULL ON UPDATE CASCADE,
--         /* =====================================================
--         INDEXES
--         ===================================================== */
--         INDEX idx_bank (company_bank_id),
